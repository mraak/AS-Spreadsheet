 ...
 * 
 * */
public class CalcLite extends EventDispatcher
{
	...
	public function getCtrl (ctrl : *) : ControlObject
	{
		...
		{
			throw("Incorect type for ctrl, supported are String, ControlObject ");
		}
	 ...
	 * */
	public function addControl (id: String, ctrl : *, valueProp : String, editStartEvents : Array = null, editEndEvents : Array = null) : void
	{
