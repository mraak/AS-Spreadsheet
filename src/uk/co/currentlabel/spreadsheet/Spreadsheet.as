package uk.co.currentlabel.spreadsheet
{
import uk.co.currentlabel.calc.Calc;
import uk.co.currentlabel.calc.Utils;
import uk.co.currentlabel.spreadsheet.components.GridList;
import uk.co.currentlabel.spreadsheet.core.spreadsheet;
import uk.co.currentlabel.spreadsheet.events.CellEvent;
import uk.co.currentlabel.spreadsheet.events.ColumnEvent;
import uk.co.currentlabel.spreadsheet.events.RowEvent;
import uk.co.currentlabel.spreadsheet.events.SpreadsheetEvent;
import uk.co.currentlabel.spreadsheet.skins.SpreadsheetSkin;
import uk.co.currentlabel.spreadsheet.utils.ResizeManager;
 ...
 * @eventType uk.co.currentlabel.spreadsheet.events.ColumnEvent.INSERT
 */
[Event(name="insertColumn", type="uk.co.currentlabel.spreadsheet.events.ColumnEvent")]

/**
 * @copy ColumnEvent#REMOVE
 * @eventType uk.co.currentlabel.spreadsheet.events.ColumnEvent.REMOVE
 */
[Event(name="removeColumn", type="uk.co.currentlabel.spreadsheet.events.ColumnEvent")]

/**
 * @copy ColumnEvent#CLEAR
 * @eventType uk.co.currentlabel.spreadsheet.events.ColumnEvent.CLEAR
 */
[Event(name="clearColumn", type="uk.co.currentlabel.spreadsheet.events.ColumnEvent")]

/**
 * @copy ColumnEvent#INSERTED
 * @eventType uk.co.currentlabel.spreadsheet.events.ColumnEvent.INSERTED
 */
[Event(name="columnInserted", type="uk.co.currentlabel.spreadsheet.events.ColumnEvent")]

/**
 * @copy ColumnEvent#REMOVED
 * @eventType uk.co.currentlabel.spreadsheet.events.ColumnEvent.REMOVED
 */
[Event(name="columnRemoved", type="uk.co.currentlabel.spreadsheet.events.ColumnEvent")]

/**
 * @copy ColumnEvent#CLEARED
 * @eventType uk.co.currentlabel.spreadsheet.events.ColumnEvent.CLEARED
 */
[Event(name="columnCleared", type="uk.co.currentlabel.spreadsheet.events.ColumnEvent")]

/**
 * @copy RowEvent#INSERT
 * @eventType uk.co.currentlabel.spreadsheet.events.RowEvent.INSERT
 */
[Event(name="insertRow", type="uk.co.currentlabel.spreadsheet.events.RowEvent")]

/**
 * @copy RowEvent#REMOVE
 * @eventType uk.co.currentlabel.spreadsheet.events.RowEvent.REMOVE
 */
[Event(name="removeRow", type="uk.co.currentlabel.spreadsheet.events.RowEvent")]

/**
 * @copy RowEvent#CLEAR
 * @eventType uk.co.currentlabel.spreadsheet.events.RowEvent.CLEAR
 */
[Event(name="clearRow", type="uk.co.currentlabel.spreadsheet.events.RowEvent")]

/**
 * @copy RowEvent#INSERTED
 * @eventType uk.co.currentlabel.spreadsheet.events.RowEvent.INSERTED
 */
[Event(name="rowInserted", type="uk.co.currentlabel.spreadsheet.events.RowEvent")]

/**
 * @copy RowEvent#REMOVED
 * @eventType uk.co.currentlabel.spreadsheet.events.RowEvent.REMOVED
 */
[Event(name="rowRemoved", type="uk.co.currentlabel.spreadsheet.events.RowEvent")]

/**
 * @copy RowEvent#CLEARED
 * @eventType uk.co.currentlabel.spreadsheet.events.RowEvent.CLEARED
 */
[Event(name="rowCleared", type="uk.co.currentlabel.spreadsheet.events.RowEvent")]
 ...
 * @eventType uk.co.currentlabel.spreadsheet.events.SpreadsheetEvent.EXPRESSIONS_CHANGE
 */
[Event(name="expressionsChange", type="uk.co.currentlabel.spreadsheet.events.SpreadsheetEvent")]

/**
 * Dispatched after expressions property gets changed and processed.
 * @eventType uk.co.currentlabel.spreadsheet.events.SpreadsheetEvent.EXPRESSIONS_CHANGED
 */
[Event(name="expressionsChanged", type="uk.co.currentlabel.spreadsheet.events.SpreadsheetEvent")]

/**
 * Dispatched after clearExpressions method is called and expressions cleared.
 * @eventType uk.co.currentlabel.spreadsheet.events.SpreadsheetEvent.EXPRESSIONS_CLEARED
 */
[Event(name="expressionsCleared", type="uk.co.currentlabel.spreadsheet.events.SpreadsheetEvent")]

/**
 * Redispatched from Calc.
 * @eventType uk.co.currentlabel.spreadsheet.events.SpreadsheetEvent.ERROR
 */
[Event(name="error", type="uk.co.currentlabel.spreadsheet.events.SpreadsheetEvent")]

/**
 * Redispatched from Calc.
 * @eventType uk.co.currentlabel.spreadsheet.events.SpreadsheetEvent.WARNING
 */
 ...
 *
 * @see uk.co.currentlabel.calc.Calc
 * @see uk.co.currentlabel.spreadsheet.ISpreadsheet
 */
...
public class Spreadsheet extends SkinnableComponent implements ISpreadsheet, IFocusManagerComponent
{
	 ...
	 *
	 * @see uk.co.currentlabel.vos.Cell
	 *
	 */
	 ...
	 * @return  An object representing the cell.
	 *
	 * @see uk.co.currentlabel.vos.Condition
	 */
	 ...
	 *
	 * @see uk.co.currentlabel.vos.CellStyles
	 */
	 ...
	 * @param options
	 *
	 * @see uk.co.currentlabel.spreadsheet.vos.MoveOptions
	 */
	 ...
	 *
	 * @see uk.co.currentlabel.spreadsheet.vos.Condition
	 */
	 ...
	 *
	 * @see uk.co.currentlabel.spreadsheet.vos.CellStyles
	 */
	 ...
	 *
	 * @see uk.co.currentlabel.sreadsheet.events.RowEvent
	 */
	 ...
	 *
	 * @see uk.co.currentlabel.spreadsheet.events.ColumnEvent
	 * @see uk.co.currentlabel.spreadsheet.events.ColumnEvent#CLEAR
	 */
	 ...
	 *
	 * @see uk.co.currentlabel.spreadsheet.events.RowEvent
	 * @see uk.co.currentlabel.spreadsheet.events.RowEvent#CLEAR
	 */
	 ...
	 *
	 * @see uk.co.currentlabel.spreadsheet.events.ColumnEvent
	 * @see uk.co.currentlabel.spreadsheet.events.ColumnEvent#INSERT
	 */
	 ...
	 *
	 * @see uk.co.currentlabel.spreadsheet.events.ColumnEvent
	 * @see uk.co.currentlabel.spreadsheet.events.ColumnEvent#REMOVE
	 */
	 ...
	 *
	 * @see uk.co.currentlabel.spreadsheet.events.RowEvent
	 * @see uk.co.currentlabel.spreadsheet.events.RowEvent#REMOVE
	 */
	 ...
	 *
	 * @see uk.co.currentlabel.spreadsheet.events.CellEvent
	 * @see uk.co.currentlabel.spreadsheet.events.CellEvent#RESIZE
	 */
